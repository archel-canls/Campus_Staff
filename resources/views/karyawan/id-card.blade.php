                    ...
                    <div class="flex items-center gap-6 mb-10">
                        <div class="relative group">
                            <div class="w-24 h-24 rounded-[2rem] bg-slate-100 overflow-hidden border-4 border-white shadow-lg relative">
                                ...
                                @else
                                {{-- Mengubah background avatar default (ui-avatars) ke warna oranye (FF9900) --}}
                                <img id="preview-foto" src="https://ui-avatars.com/api/?name={{ urlencode($karyawan->nama) }}&background=FF9900&color=fff" class="w-full h-full object-cover">
                                @endif
                            </div>
                            ...
                            <div class="relative mt-24 flex flex-col items-center z-20">
                                <div class="w-44 h-44 rounded-[2.5rem] bg-white p-2 shadow-2xl">
                                    <div class="w-full h-full rounded-[2rem] bg-slate-200 overflow-hidden border-2 border-slate-100 relative">
                                        {{-- Mengubah background avatar default (ui-avatars) di ID Card ke warna oranye (FF9900) --}}
                                        <img id="card-foto" src="{{ $karyawan->foto ? asset('storage/karyawan/foto/' . $karyawan->foto) : 'https://ui-avatars.com/api/?name='.urlencode($karyawan->nama).'&background=FF9900&color=fff' }}" class="w-full h-full object-cover">

                                        {{-- Background Status diubah ke Oren --}}
                                        <div class="absolute bottom-0 w-full bg-cdi-orange/90 backdrop-blur-sm py-1.5 text-center">

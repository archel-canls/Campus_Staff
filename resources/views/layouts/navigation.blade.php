<nav class="space-y-2">
    ...
    <a href="{{ route('manajemen-karyawan.index') }}"
        ...
        <span x-show="sidebarOpen" class="font-black uppercase italic text-[10px] tracking-widest">Manajemen Karyawan</span>
    </a>
    ...
    <a href="{{ route('karyawan.id-card') }}"
        ...
        <span x-show="sidebarOpen" class="font-black uppercase italic text-[10px] tracking-widest text-nowrap">Profil & ID Card</span>
    </a>
    ...
    <a href="{{ route('karyawan.jabatan') }}"
        ...
        <span x-show="sidebarOpen" class="font-black uppercase italic text-[10px] tracking-widest text-nowrap">Divisi & Jabatan</span>
    </a>
